...
export const createSpanishSubject = (): StudySubject<SpanishProblemType, 'spanish'> => {
    ...
    const getProblemFromEntry = (entry: DefinitionEntry, categoryBaseKey: CategoryBaseKey, sectionKey: string, keySuffix: string = ''): null | SpanishProblemType => {
    ...
    return {
        ...
        getCategories: () => [
            ...
            ...sections.map(l => ({ subjectKey, categoryKey: toStringCategoryKey('chat-only', l.sectionKey), categoryTitle: l.sectionName })),
        ],
