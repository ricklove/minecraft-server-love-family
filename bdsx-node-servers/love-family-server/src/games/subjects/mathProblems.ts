...
const calculateProblem = ({ x, y, operator }: { x: number, y: number, operator: MathProblemOperator }): MathProblemType => {
    ...
    if (operator === '/') {
        ...
        return { subjectKey: 'math', categoryKey: operator, key, formTitle, question, questionPreview: question, questionPreviewTimeMs: 1000, a: x, b: y, operator, correctAnswer: correctAnswer + '', correctAnswerValue: correctAnswer, correctAnswerStatement };
    }
